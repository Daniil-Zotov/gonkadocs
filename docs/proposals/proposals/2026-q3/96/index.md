---
title: "#96 – Stabilize in-epoch invalid SPRT on small samples"
description: "In-epoch SPRT on invalid inferences is not stable on a small sample. A few invalids can trip it before the epoch has enough data. This proposal raises invalidation_h_threshold to 40 and sets bad_parti"
template: proposals-proposals-main.html
---

# #96 – Stabilize in-epoch invalid SPRT on small samples

<div class="prop-detail-header" markdown="1">

<div class="prop-badge-row"><span class="prop-badge prop-voting">Voting</span><span class="prop-vote-countdown prop-vote-countdown-detail" data-deadline="2026-08-21T06:04:19.550951169Z"></span></div>

**Proposal ID:** `96`

**Type:** Update Params

**Submit:** 2026-08-20 18:04 UTC

**Voting:** 2026-08-20 18:04 UTC → 2026-08-21 06:04 UTC
...
[View on gonka.gg](https://gonka.gg/network/proposals/96){:target="_blank"}

</div>

In-epoch SPRT on invalid inferences is not stable on a small sample. A few invalids can trip it before the epoch has enough data. This proposal raises invalidation_h_threshold to 40 and sets bad_participant_invalidation_rate to 18e-2. At large sample sizes the threshold is about 10% invalid, so participants below that are not punished. Higher rates still trigger, 18% in about 360 samples and 12% in about 1650. Small samples cannot trigger it. At least 32 flagged invalids are required, and at 500 samples the observed rate must exceed 16%. Downtime SPRT is unused and is turned off. Epoch-end stats tests still work.
...
<div class="prop-tally">
  ...
  <div class="prop-tally-stats">
    <span class="prop-tally-yes-text">Yes <strong>100.0%</strong> (203,826)</span>
    ...
    <span class="prop-tally-total-text">Total 203,826 votes</span>
    <span class="prop-tally-yes-text">✓ Turnout <strong>52.8%</strong> (203,826 / 385,866) · Quorum <strong>25%</strong> (96,466)</span>
  </div>
</div>
