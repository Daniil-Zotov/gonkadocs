---
title: "#93 – Upgrade devshard v4 runtime to v4.0.1"
description: "Replace the existing devshard v4 runtime with v4.0.1. This performance and resource-management patch does not change protocol, inference, validation, or economic behavior. It removes per-block chain q"
template: proposals-proposals-main.html
---

# #93 – Upgrade devshard v4 runtime to v4.0.1

<div class="prop-detail-header" markdown="1">

<div class="prop-badge-row"><span class="prop-badge prop-voting">Voting</span><span class="prop-vote-countdown prop-vote-countdown-detail" data-deadline="2026-08-03T00:21:18.753587476Z"></span></div>

**Proposal ID:** `93`

**Type:** Update Params

**Submit:** 2026-08-01 00:21 UTC

**Voting:** 2026-08-01 00:21 UTC → 2026-08-03 00:21 UTC
...
[View on gonka.gg](https://gonka.gg/network/proposals/93){:target="_blank"}

</div>

Replace the existing devshard v4 runtime with v4.0.1. This performance and resource-management patch does not change protocol, inference, validation, or economic behavior. It removes per-block chain queries by switching epoch tracking to event-driven updates and aligns in-memory host-session and validation-worker cleanup with epoch pruning. versiond will automatically download and verify the replacement binary; no mainnet restart or manual host action is required.
...
<div class="prop-tally">
  <div class="prop-tally-bar">
    <div class="prop-tally-yes" style="width:19.9%"></div>
    <div class="prop-tally-no" style="width:0.0%"></div>
    <div class="prop-tally-veto" style="width:0.0%"></div>
    <div class="prop-tally-abstain" style="width:0.0%"></div>
  </div>
  <div class="prop-tally-stats">
    <span class="prop-tally-yes-text">Yes 111,386 (100.0%)</span>
    <span class="prop-tally-no-text">No 0 (0.0%)</span>
    <span class="prop-tally-veto-text">Veto 0 (0.0%)</span>
    <span class="prop-tally-abstain-text">Abstain 0 (0.0%)</span>
    <span class="prop-tally-total-text">Total 111,386 votes</span>
    <span class="prop-tally-veto-text">✗ Turnout 111,386 / 559,232 (19.9%) · Quorum 25% (139,808)</span>
  </div>
</div>
