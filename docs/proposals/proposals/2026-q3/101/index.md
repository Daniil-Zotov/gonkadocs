---
title: "#101 – Add GLM-5.3-Flash, remove Kimi-K2.6 and GLM-5.2-FP8 from PoC models"
description: "Add zai-org/GLM-5.3-Flash as a governance-approved model and PoC model. Remove moonshotai/Kimi-K2.6 and zai-org/GLM-5.2-FP8 from poc_params.models.

MiniMaxAI/MiniMax-M2.7 and deepseek-ai/DeepSeek-V4-"
template: proposals-proposals-main.html
---

# #101 – Add GLM-5.3-Flash, remove Kimi-K2.6 and GLM-5.2-FP8 from PoC models

<div class="prop-detail-header" markdown="1">

<div class="prop-badge-row"><span class="prop-badge prop-voting">Voting</span><span class="prop-vote-countdown prop-vote-countdown-detail" data-deadline="2026-09-10T23:17:27.402122371Z"></span></div>

**Proposal ID:** `101`

**Type:** Register Model, Update Params

**Submit:** 2026-09-08 23:17 UTC

**Voting:** 2026-09-08 23:17 UTC → 2026-09-10 23:17 UTC
...
[View on gonka.gg](https://gonka.gg/network/proposals/101){:target="_blank"}

</div>

Add zai-org/GLM-5.3-Flash as a governance-approved model and PoC model. Remove moonshotai/Kimi-K2.6 and zai-org/GLM-5.2-FP8 from poc_params.models.

MiniMaxAI/MiniMax-M2.7 and deepseek-ai/DeepSeek-V4-Flash-0731 are not affected: their PoC parameters and weights remain unchanged. All other chain parameters remain unchanged.

The GLM-5.3-Flash model and its parameters were proposed by the kaitaku.ai team, independently validated by vbgd0, and are now proposed jointly. Release inputs, measurements and the reasoning behind the thresholds are in gonka-ai/gonka#1734.

GLM-5.3-Flash PoC parameters: seq_len 1024, dist_threshold 0.44, p_mismatch 0.10, p_value_threshold 0.05, weight_scale_factor 0.62; validation_threshold 0.951.
...
The activation epoch (penalty_start_epoch) for GLM-5.3-Flash is 394.
...
<div class="prop-tally">
  <div class="prop-tally-bar">
    <div class="prop-tally-yes" style="width:58.7%"></div>
    <div class="prop-tally-no" style="width:0.0%"></div>
    <div class="prop-tally-veto" style="width:0.0%"></div>
    <div class="prop-tally-abstain" style="width:0.6%"></div>
  </div>
  <div class="prop-tally-stats">
    <span class="prop-tally-yes-text">Yes <strong>99.0%</strong> (329,806)</span>
    <span class="prop-tally-no-text">No <strong>0.0%</strong> (0)</span>
    <span class="prop-tally-veto-text">Veto <strong>0.0%</strong> (0)</span>
    <span class="prop-tally-abstain-text">Abstain <strong>1.0%</strong> (3,168)</span>
    <span class="prop-tally-total-text">Total 332,974 votes</span>
    <span class="prop-tally-yes-text">✓ Turnout <strong>59.3%</strong> (332,974 / 561,395) · Quorum <strong>25%</strong> (140,348)</span>
  </div>
</div>
...
<tr><td><a href="https://gonka.gg/address/gonka1erprg28u792w5nfdvcwtgyhlmyx8tsjch06gkq" target="_blank" class="prop-voter-addr">gonka1erprg2…h06gkq</a></td><td><span class="prop-voter-option prop-vote-yes">Yes 100.0%</span></td></tr>
