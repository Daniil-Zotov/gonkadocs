---
title: "Dev Team Funding @gmorgachev"
template: proposals-main.html
---

# Dev Team Funding @gmorgachev
...
I plan to submit a proposal requesting 1.5m USDT from the community pool. The funding would support an independent engineering team working on core protocol development aligned with the roadmap

---

## Full Proposal

https://github.com/gonka-ai/gonka/discussions/1464
...
Collaboration
If established, this team would contribute to Gonka alongside individual contributors and other community-funded teams, such as the approved External Test Lab and Community DevNet. It would collaborate with contributors across the community on protocol development and testing. I hope to see more teams working on different parts of Gonka.
...
Обсуждение в тг для пропозера, хостов, комитетов и активных членов сообщества 
https://telegram.me/gonka_proposals

---

### 💬 Даниил Зотов
*2026-07-31 18:56* · 👍 0 · 👎 0

⚫ AMA с Глебом Моргачевым "Dev Team Funding proposal"

🕣 Понедельник, 3 августа
08:30 LA · 15:30 UTC · 18:30 МСК

Проведём AMA-сессию с Глебом Моргачевым, посвящённую proposal о финансировании независимой команды разработки.

Обсудим ключевые вопросы proposal:
• На какие задачи запрашивается финансирование;
• Как будет устроена независимая команда разработки;
• Механика финансирования;
• Прозрачность расходов, отчётность и роль Глеба в инициативе;
• Другие вопросы.

💻 Zoom: ссылка будет к началу сессии
🗣 Язык: русский
📄 Proposal: https://github.com/gonka-ai/gonka/discussions/1464

🎙 Гость: @gmorgachev — Глеб Моргачев, Gonka co-creator
🎤 Ведущие: @paranko и @dem_ww

---

### 💬 Даниил Зотов
*2026-08-01 19:59* · 👍 0 · 👎 0

вопросы:

какова роль Product Science сейчас и в ближайшей перспективе работы над протоколом? Новая команда заменит ее или работа будет вестись параллельно?
сейчас в комьюнити пуле 720к usdt - согласован ли ваш пропозал с BF и планируется ли новый транш от BF до создания пропозала ончейн?
...
[View on gonka.vote](https://gonka.vote/proposal/8a252390-79b4-4a43-b520-c3fc412ef642)
