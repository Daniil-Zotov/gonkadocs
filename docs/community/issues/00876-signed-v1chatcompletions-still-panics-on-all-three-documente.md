...
<li>If the same <code>500 panic</code> persists, inspect the remaining nil / empty-result boundaries in the public inference path, especially:
   - requester lookup
   - executor selection
   - executor forwarding</li>
...
<p>This is intentionally sanitized. I can provide the exact reproduction script and exact headers privately if useful.</p>
</details>
  </div>
</div>
<div class="issues-comment">
