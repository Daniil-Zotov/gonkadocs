...
<li>The task plan now explicitly separates:
   - exact-height transition schedule for <code>BeginBlock</code>
   - start-height overlap index for scheduling-time range scans</li>
</ol>
