...
**Автор:** [@paranjko](https://github.com/paranjko) · **Категория:** :bookmark_tabs: Governance Proposal Reports · **Создано:** 2026-08-11 23:12 UTC · **Обновлено:** 2026-08-11 23:12 UTC
...
|---|---|
| DevNet design agreed | Done — [architecture note](https://github.com/paranjko/external-test-lab/blob/main/devnet/architecture.md) |
...
- **Deployment runbook `1.0.0-alpha.1`** ([net-deployment-runbook/](https://github.com/paranjko/external-test-lab/tree/main/net-deployment-runbook)) — reproducible baseline on `testnet-0.2.14` (phased CLI: prepare → identities → qualify-ml → genesis → join → verify), governed `0.2.14 → 0.2.15` upgrade rehearsal, single-node stop/start/verify/reset, network reset contract. The M2 artifact "runbook sufficient to reproduce a node" ([ROLE-JOIN.md](https://github.com/paranjko/external-test-lab/blob/main/net-deployment-runbook/ROLE-JOIN.md)) is already published.
...
| M1 requirement | Status |
|---|---|
| Initial test strategy | Done — [testing/test-strategy.md](https://github.com/paranjko/external-test-lab/blob/main/testing/test-strategy.md) |
| QA search and selection | Done — first engineer hired and active |
| Operating model | Done — [task board](https://github.com/users/paranjko/projects/1), [issue templates](https://github.com/paranjko/external-test-lab/tree/main/.github/ISSUE_TEMPLATE) (defect / validation request / DevNet access), [SECURITY.md](https://github.com/paranjko/external-test-lab/blob/main/SECURITY.md) private disclosure path |
