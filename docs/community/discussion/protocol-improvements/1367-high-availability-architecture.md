...
**Автор:** [@a-kuprin](https://github.com/a-kuprin) · **Категория:** :gear: Protocol Improvements · **Создано:** 2026-06-25 08:16 UTC · **Обновлено:** 2026-07-22 05:54 UTC
...
([../high-availability-architecture.md](https://github.com/gonka-ai/gonka/blob/ak/pixelplex-refactoring-into-r2/devshard/docs/high-availability-architecture.md)) and the binary-rollout design
([../rolling-update.md](https://github.com/gonka-ai/gonka/blob/ak/pixelplex-refactoring-into-r2/devshard/docs/rolling-update.md)). It does **not** change the
inference-chain.
...
[../rolling-update.md](https://github.com/gonka-ai/gonka/blob/ak/pixelplex-refactoring-into-r2/devshard/docs/rolling-update.md). The HA stack depends on the same
...
The [rolling-update plan](https://github.com/gonka-ai/gonka/blob/ak/pixelplex-refactoring-into-r2/devshard/docs/rolling-update.md) defines how we roll out **new
