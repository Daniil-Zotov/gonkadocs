---
title: "#1141 — IBC USDT Withdrawal Guide"
source: https://github.com/gonka-ai/gonka/discussions/1141
discussion_number: 1141
category: show-and-tell
synced_at: 2026-06-15T18:30:43Z
---

> 🔄 **Авто-синхронизация:** из [Discussion #1141](https://github.com/gonka-ai/gonka/discussions/1141) каждые 6 часов. Прямые правки будут перезаписаны.
...
### Комментарий 1 — [@rufatpro](https://github.com/rufatpro)

*2026-05-01 14:12 UTC*

Спасибо за инструкцию. :)

Способ вывода, конечно, оставляет желать лучшего, так как содержит очень много шагов.

### Комментарий 2 — [@mtvnastya](https://github.com/mtvnastya)

*2026-05-14 23:32 UTC*

@paranjko looks like a helpful instruction, can you open a PR to add it to gonka.ai documentation repo?

**↳ Ответ от [@paranjko](https://github.com/paranjko)** · *2026-05-19 02:38 UTC*

> Good call. Just did it!

### Комментарий 3 — [@a-kuprin](https://github.com/a-kuprin)

*2026-05-20 19:41 UTC*

@paranjko 
BTW.
I've used https://app.squidrouter.com to move KAVA IBC USDT, to ETH USDT directly.
So it was just use keplr to move to KAVA and use squidrouter to move directly to ETH USDT

**↳ Ответ от [@GLiberman](https://github.com/GLiberman)** · *2026-05-20 20:48 UTC*

> Per SquidRouter calculator transaction takes around 17 minutes (which is significantly longer) plus looks like fees are a bit higher and I'm not sure that calculator shows correct final amount as there is extra exchange will take place: KAVA IBC USDT > Axelar USDT. 

**↳ Ответ от [@a-kuprin](https://github.com/a-kuprin)** · *2026-05-20 21:17 UTC*
